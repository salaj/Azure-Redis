...
namespace ContosoTeamStats.Controllers
{
    public class TeamsController : Controller
    {
        ...
        //public static ConnectionMultiplexer Connection => TeamsController.lazyConnection.Value;
        ...
        //#region Retrieval of team statistics
        ...
        ///// <summary>
        ///// The GetFromList method reads the team statistics from cache as a serialized List. If the statistics are not present in the cache, a cache miss occurs. For a cache miss, the team statistics are read from the database and then stored in the cache for the next request.
        ///// </summary>
        ///// <returns></returns>
